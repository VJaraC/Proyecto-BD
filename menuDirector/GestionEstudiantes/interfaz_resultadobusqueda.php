        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-blue-500">
                    <tr>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Rut Estudiante</th>
                        ...
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Rut Apoderado</th>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Año Ingreso</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    foreach ($consulta as $row) {
                        ...
                        echo "<td class='px-6 py-4 whitespace-nowrap'>" . htmlspecialchars($row['apoderado_rut']) . "</td>";
                        echo "<td class='px-6 py-4 whitespace-nowrap'>" . htmlspecialchars($row['estudiante_ano_ingreso']) . "</td>";
                        echo "<td class='px-6 py-4 whitespace-nowrap'>";
                        echo "<a href='interfaz_actualizar_alumno.php?rut=" . htmlspecialchars($row['estudiante_rut']) . "' class='inline-block px-4 py-2 text-white bg-green-500 rounded hover:bg-green-600'>Actualizar</a> ";
                        echo "<form action='backend_deshabilitarEstudiante.php' method='POST' style='display:inline;'>";
                        echo "<input type='hidden' name='rut' value='" . htmlspecialchars($row['estudiante_rut']) . "'>";
