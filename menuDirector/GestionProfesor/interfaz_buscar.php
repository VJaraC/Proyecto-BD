...
<body>
    <section class="section">
        <div class="container">
            ...
            <div class="box">
                <form id="search-form" action="backend_buscarProfesor.php" method="post">
                    <div class="field">
                        ...
                        <div class="control">
                            <div class="select">
                                <select id="filtro" name="filtro">
                                    ...
                                    <option value="persona_datos_nombres">Nombres Profesor</option>
                                    <option value="persona_datos_apellidos">Apellidos Profesor</option>
                                    ...
                                    <option value="profesor_pedagogia">Pedagogia</option>
                                    <option value="profesor_tipo_de_contrato">Tipo de contrato</option>
                                </select>
                            </div>
                        </div>
                    </div>
