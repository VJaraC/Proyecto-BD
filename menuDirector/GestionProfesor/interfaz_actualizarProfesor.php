...
<body class="bg-gray-100">
    <div class="container mx-auto mt-10 p-5 bg-white shadow-lg rounded-lg border border-gray-200">
        <h1 class="text-3xl font-bold mb-5 text-blue-600">Actualizar Datos del Profesor</h1>
        <div class="overflow-x-auto">
            <form action="backend_actualizarProfesor.php" method="post">
                <input type="hidden" name="profesor_rut_modificar" value="<?php echo htmlspecialchars($rut); ?>">
                <div class="mb-4">
                    ...
                    <select id="campo" name="atributo" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        ...
                        <option value="profesor_rut">RUT</option>
                        ...
                        <option value="profesor_pedagogia">RUT del Apoderado</option>
                        <option value="profesor_tipo_de_contrato">Año de Ingreso del Estudiante</option>
                        <option value="fecha_de_contratacion">Estado</option>
                    </select>
                </div>
                <div class="mb-4">
