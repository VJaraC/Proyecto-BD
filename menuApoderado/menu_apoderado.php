...
<nav class="navbar">
    ...
    <div class="navbar-end">
        <form action="./../loginApoderado.php" method="post">
...
<div class="menu-container">
    <div class="menu-box">
        ...
        <div class="menu-grid">
            ...
            <a href="backend_seleccion_estudiante.php" class="menu-item">
                <i class="fas fa-sticky-note"></i>
                <span>Consultar Anotaciones</span>
            </a>
            <a href="interfaz_seleccion_estudiante_notas.php" class="menu-item">
